   ...
   <xsl:template match="/">
      ...
      <xsl:result-document href="index.html">
         <xsl:call-template name="html">
            <xsl:with-param name="content" select=".//abstract"/>
         </xsl:call-template>
      </xsl:result-document>
      <xsl:result-document href="testament.html">
         <xsl:call-template name="html">
            <xsl:with-param name="content" select=".//div[@type='will']"/>
         </xsl:call-template>
      </xsl:result-document>
      <xsl:result-document href="codicille.html">
         <xsl:call-template name="html">
            <xsl:with-param name="content" select=".//div[@type='codicil']"/>
         </xsl:call-template>
      </xsl:result-document>
   </xsl:template>
            ...
            <header>
               ...
               <nav>
                  <ul>
                     ...
                     <li><a href="codicille.html">Codicille</a></li>
                  </ul>
               </nav>
            </header>
